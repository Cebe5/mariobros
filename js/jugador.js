...
scene.add(mario);
<<<<<<< HEAD
var mS = { vel:new THREE.Vector3(), canJump:false, animT:0, invincible:0, big:false, isDead:false, growing:false, growTimer:0, starMode:0 };
=======
...
<<<<<<< HEAD
  mS.vel.set(0,0,0); mS.canJump = false; mS.isDead = false; mS.invincible = 0; mS.growing = false; mS.growTimer = 0; mS.starMode = 0;
=======
